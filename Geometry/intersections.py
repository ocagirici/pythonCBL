...
from Geometry.diagnostic import diag_print
from Geometry.matfunc import Mat, Vec

from Geometry.tolerance import *
...
def sss_int(p, r):
    p1 = vector.vector(p[0])
    p2 = vector.vector(p[1])
    p3 = vector.vector(p[2])
    r1, r2, r3 = r
    solutions = []
